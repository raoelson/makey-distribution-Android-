...
public class FocusBoxView extends View {
    private static final int MIN_FOCUS_BOX_WIDTH = 10;
    ...
    private void updateBoxRect(int dW, int dH) {
        ...
        int leftOffset = (ScrRes.x - newWidth) / 4;
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(frame.left - 15, frame.top - 15, 15, paint);
        canvas.drawCircle(frame.right + 15, frame.top - 15, 15, paint);
        canvas.drawCircle(frame.left - 15, frame.bottom + 15, 15, paint);
        canvas.drawCircle(frame.right + 15, frame.bottom + 15, 15, paint);
